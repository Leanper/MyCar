                ...
                customMessage.setOnSendCompleteCallback(new BasicCallback() {
                    ...
                    public void gotResult(int i, String s) {
                        if (i == 0) {
                            ...
                            LogUtils.i("CreateSigCustomMsgActivity", "JMessageClient.createSingleCustomMessage" + ", responseCode = " + i + " ; LoginDesc = " + s);
                        }else {
                            Toast.makeText(getApplicationContext(), "发送失败", Toast.LENGTH_SHORT).show();
                            LogUtils.i("CreateSigCustomMsgActivity", "JMessageClient.createSingleCustomMessag" + ", responseCode = " + i + " ; LoginDesc = " + s);
                        }
                    }
                });
