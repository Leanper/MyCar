...
public class SureTravelActivity extends MVPBaseActivity<SureTravelContract.View, SureTravelPresenter> implements SureTravelContract.View,View.OnClickListener {
...
//                PickerUtils.timePicker(this, mEtUsercarTime);
            ...
            case R.id.but_release_plan:
                if(judgeIsNull()){
                    ...
                    if(isStart)
                        ToastUtil.show(SureTravelActivity.this,"起始地信息未完善");
                    else if(isEnd)
                        ToastUtil.show(SureTravelActivity.this,"结束地信息未完善");
                    else if(isTime)
                        ToastUtil.show(SureTravelActivity.this,"时间信息未完善");
                    else if(isType)
                        ToastUtil.show(SureTravelActivity.this,"车类型信息未完善");
                }
                break;
